window.initCocosGame  = function(){
   ...
   var CardsLoaderScene = cc.Scene.extend({
       ...
       init: function() {
           ...
           for (var i = 0; i < 5; i++) {
               ...
               var x = centerPos.x + Math.cos(angle) * cardRadius;
               var y = centerPos.y + Math.sin(angle) * cardRadius;
   ...
   cc.game.onStart = function() {
    ...
    //   }
       ...
       // Sử dụng CardsLoaderScene thay vì cc.LoaderScene
...
var yPos = 35; // khoảng cách từ đáy màn hình
